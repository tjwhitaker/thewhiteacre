          ...
          return (
            "small" === i.type
              ...
              ? ((c = 1080 * Sr[i.size]),
                (h = (Sr[i.size] + s) / o),
                (l = (Sr[i.size] + s + yr) / o),
                ((r = br("sqrtSize" + i.size, l, c, s, t)).style.minWidth =
                  "1.02em"),
                (n = 1 / o))
              : ((l = e + s + yr),
                (h = e + s),
        ...
        if ("sout" === o)
          ...
          ;/box/.test(o)
            ...
            /fbox|boxed|fcolorbox/.test(o)
              ? ((r.style.borderStyle = "solid"), (r.style.borderWidth = F(b)))
              : "angl" === o &&
                0.049 !== b &&
                ((r.style.borderTopWidth = F(b)),
                (r.style.borderRightWidth = F(b))),
            (h = i.depth + y),
            e.backgroundColor &&
      ...
      nn = function (e, t) {
        ...
        if (
          ...
          u - o.depth - (w + 0.5 * c) < p &&
            ...
            w - 0.5 * c - (b.height - d) < p &&
              (d += p - (w - 0.5 * c - (b.height - d)))
          var k = -(w - 0.5 * c)
          f = Ke.makeVList(
            {
              positionType: "individualShift",

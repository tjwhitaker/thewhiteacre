        ...
        (div (@ (class "home"))
          ...
          (div (@ (class "professional"))
            (div (@ (class "wrapper"))
              ...
              ;   (div (@ (class "item"))
              ;     (p "Rock Climbing")
              ;     (p "10+ years of experience")
              ;     (p "President and Founder of the Chico Climbing Club (2012-2014)")
              ;     (p "Bishop, Yosemite, Lake Tahoe, Red Rocks, Joe's Valley, Rocky Mountain National Park, Roy")
              ;   )
              ;   (div (@ (class "item"))
              ;     (p "Chess")
              ;     (p "Lifetime hobbyist")
              ;     (p "10k+ games over all my accounts")
              ;     (p "~1800 Lichess Rapid")
              ;   )
              ;   (div (@ (class "item"))
              ;     (p "Gaming")
              ;     (p "1st Place in the 2012 Mario Kart 64 Classic")
              ;     (p "")
              ;   )
              ;   (div (@ (class "item"))
              ;     (p "Music")
              ...
              ;     (p "Electronics")
              ;     (p "Built my own PC")
              ;     (p "Bottlehead Microphone Tube Amp")
              ;     (p "Nvidia Jetson ML Experience")
              ;   )
              ; )
            )
          )
          ...
          ;   (div (@ (class "item"))
          ;     (img (@ (src "/static/mastersword.jpg"))))
          ;   (div (@ (class "item"))

        ...
        (div (@ (class "home"))
          ...
          (main
            (div (@ (class "hero"))
              (div (@ (class "overlay")) "")
                (div (@ (class "wrapper"))
                  ...
                  (p "Welcome! My name is Tim Whitaker and I'm a computer scientist studying neural network optimization and analysis. Wittes Ende is a website I'm building to explore and share cool research in machine learning.")))
            

            (div (@ (class "intro"))
              (div (@ (class "wrapper"))
                (blockquote "What I'm About")
            ...
            (div (@ (class "hero2"))
              (div (@ (class "overlay")) "")
              (div (@ (class "wrapper"))
                (h1 "A researcher with perspective")
                (p "Hi. My name is Tim Whitaker and I'm a computer scientist studying neural network optimization and analysis. When I'm not programming, I'm probably outside rock climbing with my beautiful wife.")
              )
            )
            ...
            (div (@ (class "reference"))
              (p "P.S. I built this website by hand using " (a (@ (href "#")) "scheme") ". All hero images are generated with neural networks via " (a (@ (href "#")) "Midjourney") ".")
            )
          )

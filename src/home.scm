        ...
        (div (@ (class "home"))
          ...
          (main
            (div (@ (class "hero"))
              (div (@ (class "overlay")) "")
                (div (@ (class "wrapper"))
                  ...
                  (p "Welcome! My name is Tim Whitaker and I'm a computer scientist studying neural network optimization and analysis. Wittes Ende is a website I'm building to explore state of the art projects in machine learning.")))
            ...
            (div (@ (class "hero2"))
              (div (@ (class "overlay")) "")
              (div (@ (class "wrapper"))
                (h1 "A Computer NeuroScientist Who Loves To Climb")
                (p "The resident bad boy of computer science. I am a PhD candidate at Colorado State University working on algorithms to improve the ways that we analyze and optimize neural networks.")
              )
            )
            ...
            (div (@ (class "personal"))
              (div (@ (class "content"))
                (div (@ (class "wrapper"))
                    ...
                    (p "That's right. I build machine learning models.")
                )
              )
              (div (@ (class "image"))

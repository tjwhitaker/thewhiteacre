          ...
          (div (@ (class "personal"))
            (div (@ (class "content"))
              (div (@ (class "wrapper"))
                ...
                (p "When I am not programming or working on my research, I am probably rock climbing or playing chess. I also skate, snowboard, wakeboard, mountain bike, fly fish, and make music.")
              )
            )
            (div (@ (class "image"))

            ...
            (div (@ (class "catalog"))
              (div (@ (class "wrapper"))
                (div (@ (class "item"))
                  ...
                  (p "The beginning of our great field of research.")
                  (div (@ (class "links"))
                    (a (@ (href "https://www.cs.cmu.edu/~./epxing/Class/10715/reading/McCulloch.and.Pitts.pdf")) "Paper")))

                (div (@ (class "item"))
                  (h1 "Neocognitron (1979)")
                  (p (small "Kunihiko Fukushima"))
                  (p "A lesser known piece of history. The first convolutional neural network. A breakthrough development for computer vision.")
                  (div (@ (class "links"))
                    (a (@ (href "http://www.scholarpedia.org/article/Neocognitron")) "Paper")))

                (div (@ (class "item"))
                  (h1 "Hopfield Network (1982)")
                  (p (small "J. J. Hopfield"))
                  (p "The first convolutional neural network. A breakthrough development for computer vision.")
                  (div (@ (class "links"))
                    (a (@ (href "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC346238/pdf/pnas00447-0135.pdf")) "Paper")))
                
                (div (@ (class "item"))
                  (h1 "LeNet (1989)")
                  (p (small "Yann LeCun"))
                  (p "Most popularly known for it's inclusion in the paper that introduced backpropagation. This convolutional architecture would become the foundation for the most powerful computer vision models of the future.")
                  (div (@ (class "links"))
                    (a (@ (href "http://yann.lecun.com/exdb/publis/pdf/lecun-01a.pdf")) "Paper")))
